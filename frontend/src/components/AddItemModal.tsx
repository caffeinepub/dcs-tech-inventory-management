...
export default function AddItemModal({ onClose }: AddItemModalProps) {
  ...
  const fields = [
    { id: 'name', label: 'Item Name *', placeholder: 'e.g. iPhone 14 Pro', required: true },
    { id: 'sku', label: 'SKU *', placeholder: 'e.g. IPHONE-14P-BLK', required: true },
    { id: 'category', label: 'Category *', placeholder: 'e.g. electronics', required: true },
    { id: 'unit', label: 'Unit *', placeholder: 'e.g. units, pieces, boxes', required: true },
    { id: 'quantity', label: 'Initial Quantity *', placeholder: '0', type: 'number', required: true },
    { id: 'lowStockThreshold', label: 'Low Stock Threshold *', placeholder: '10', type: 'number', required: true },
    ...
    <Dialog open={true} onOpenChange={(open) => !open && onClose()}>
      ...
      >
        ...
        <ScrollArea className="flex-1">
          <form id="add-item-form" onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
            {fields.map(field => (
